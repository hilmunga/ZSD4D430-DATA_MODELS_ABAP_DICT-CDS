CLASS zcl_20002_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_20002_TABLE_TYPE IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
     DATA addresses TYPE z20002t_addresses.
...
*    DATA person TYPE st_person_deep.
     DATA person TYPE z20002s_person_deep.
...
*    DATA persons TYPE tt_persons.
 DATA persons TYPE z20002t_persons.
